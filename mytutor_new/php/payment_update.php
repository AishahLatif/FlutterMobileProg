...
function printTable($receiptid, $name, $amount, $paidstatus, $message) {
    echo "
    <html>
    <head>
    ...
    <div = class = 'w3-padding'> <h4>Thankyou for your payment</h4>
    <p>The following is your receipt</p></div>
    <div class = 'w3-container w3-padding'>
        <table class='w3-table w3-striped w3-bordered'>
        <tr><th>Receipt ID</tj><td>$receiptid<td></tr>
